...
fi_1 = open('../YOLOX_outputs/cocochucheng_yolox_s_pan_pre_221015/train_log.txt','r',encoding='utf-8')
fi_2 = open('../YOLOX_outputs/cocochucheng_yolox_s_pan_221015/train_log.txt','r',encoding='utf-8')
...
for line in lines:
    if 'total_loss' in line:
        ...
        #print(line)
        line = line.split('conf_loss: ')[-1].split(', cls_loss:')[0]
...
plt.plot(x, list_loss, label="Pretrained")
iters_num2 *= 10
x2 = np.arange(0, iters_num2, 10)
print(iters_num2)
plt.plot(x2, list_loss2, label="No pretrained")
...
# plt.show()
plt.savefig('../YOLOX_outputs/exp_result_fig/cocochucheng_yolox_s_pan_pre_ObjLOSS.png', bbox_inches='tight')
